(() => {
    ...
    var e = {
            ...
            3153: (e, t, i) => {
                ...
                a.push([e.id, ".radar-spinner[data-v-7ca7cfc9],.radar-spinner *[data-v-7ca7cfc9]{-webkit-box-sizing:border-box;box-sizing:border-box}.radar-spinner[data-v-7ca7cfc9]{height:60px;position:relative;width:60px}.radar-spinner .circle[data-v-7ca7cfc9]{-webkit-animation:radar-spinner-animation-data-v-7ca7cfc9 2s infinite;animation:radar-spinner-animation-data-v-7ca7cfc9 2s infinite;height:100%;left:0;position:absolute;top:0;width:100%}.radar-spinner .circle[data-v-7ca7cfc9]:first-child{-webkit-animation-delay:.3s;animation-delay:.3s;padding:0}.radar-spinner .circle[data-v-7ca7cfc9]:nth-child(2){-webkit-animation-delay:.3s;animation-delay:.3s;padding:5.45455px}.radar-spinner .circle[data-v-7ca7cfc9]:nth-child(3){-webkit-animation-delay:.3s;animation-delay:.3s;padding:10.90909px}.radar-spinner .circle[data-v-7ca7cfc9]:nth-child(4){-webkit-animation-delay:0ms;animation-delay:0ms;padding:16.36364px}.radar-spinner .circle-inner[data-v-7ca7cfc9],.radar-spinner .circle-inner-container[data-v-7ca7cfc9]{border:2.72727px solid transparent;border-radius:50%;height:100%;width:100%}.radar-spinner .circle-inner[data-v-7ca7cfc9]{border-left-color:#ff1d5e;border-right-color:#ff1d5e}@-webkit-keyframes radar-spinner-animation-data-v-7ca7cfc9{50%{-webkit-transform:rotate(180deg);transform:rotate(180deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}@keyframes radar-spinner-animation-data-v-7ca7cfc9{50%{-webkit-transform:rotate(180deg);transform:rotate(180deg)}to{-webkit-transform:rotate(0deg);transform:rotate(0deg)}}", ""]);
                const r = a
            },
            4633: (e, t, i) => {
                i.d(t, {
                ...
                e.exports = function(e) {
                    ...
                    return t.toString = function() {
                        ...
                        for (var o = 0; o < e.length; o++) {
                            var l = [].concat(e[o]);
                            n && a[l[0]] || (i && (l[2] ? l[2] = "".concat(i, " and ").concat(l[2]) : l[2] = i), t.push(l))
                        }
                    }, t
                }
            },
            3379: (e, t, i) => {
                ...
                function p(e, t, i, n) {
                    var a = i ? "" : n.media ? "@media ".concat(n.media, " {").concat(n.css, "}") : n.css;
                ...
                function u(e, t) {
                    ...
                    if (t.singleton) {
                        var r = b++;
                        i = h || (h = d(t)), n = p.bind(null, i, r, !1), a = p.bind(null, i, r, !0)
                    } else i = d(t), n = m.bind(null, i, t), a = function() {
                        ! function(e) {
                ...
                e.exports = function(e, t) {
                    ...
                    return function(e) {
                        if (e = e || [], "[object Array]" === Object.prototype.toString.call(e)) {
                            ...
                            for (var r = l(e, t), d = 0; d < i.length; d++) {
                                var c = o(i[d]);
    ...
    i.n = e => {
        ...
        function s(e, t, i, n, a, r, s, o) {
            var l, d = "function" == typeof e ? e.options : e;
            if (t && (d.render = t, d.staticRenderFns = i, d._compiled = !0), n && (d.functional = !0), r && (d._scopeId = "data-v-" + r), s ? (l = function(e) {
                ...
                }, d._ssrRegister = l) : a && (l = o ? function() {
        ...
        const o = function(e, t) {
                ...
                i && (i.setAttribute("id", e), i.innerHTML = `@keyframes ${e} {${t}}`, document.body.appendChild(i))
            },
            l = function(e) {
            ...
            d = {
                ...
                beforeDestroy() {
                    l(this.animationName)
                },
                methods: {
                    updateAnimation() {
                        l(this.animationName), o(this.animationName, this.generateKeyframes())
                    },
                    generateKeyframes() {
        ...
        const p = {
            ...
            beforeDestroy() {
                l(this.smallDotName), l(this.bigDotName)
            },
            methods: {
                updateAnimation() {
                    l(this.smallDotName), o(this.smallDotName, this.generateSmallDotKeyframes()), l(this.bigDotName), o(this.bigDotName, this.generateBigDotKeyframes())
                },
            ...
            computed: {
                ...
                ringsStyles() {
                    const e = [],
                        ...
                        i = t;
                    for (let n = 1; n <= this.ringsNum; n++) {
                        let a = Object.assign({
                            animationDelay: 50 * n + "ms",
                            height: `${t+(n-1)*i}px`,
                            width: `${t+(n-1)*i}px`
                        }, this.ringStyle);
                        e.push(a)
            ...
            computed: {
                ...
                ringsStyles() {
                    const e = [],
                        ...
                        i = 2 * t,
                        n = .2 * this.size;
                    for (let a = 0; a < this.ringsNum; a++) {
                        const r = this.size - n * a + "px",
                            s = i * a + "px",
                            o = Object.assign({
                                animationDelay: .1 * this.animationDuration * (this.ringsNum - a - 1) + "ms",
                                height: r,
                                width: r,
                                left: s,
                                top: s,
        ...
        const B = {
            ...
            computed: {
                ...
                rhombusesStyles() {
                    const e = [],
                        t = .05 * this.animationDuration;
                    for (let i = 1; i <= this.rhombusesNum; i++) e.push(Object.assign({
                        animationDelay: t * (i + 1) + "ms"
                    }, this.rhombusStyle));
                    return e
                },
                bigRhombusStyle() {
        ...
        const A = {
            ...
            computed: {
                ...
                squaresStyles() {
                    const e = [],
                        t = .5 * this.animationDuration;
                    for (let i = 1; i <= this.squaresNum; i++) e.push(Object.assign({
                        animationDelay: `${i%2==0?t:0}ms`
                    }, this.squareStyle));
                    return e
                }
            }
        ...
        const M = {
            ...
            computed: {
                ...
                squaresStyles() {
                    const e = [];
                    for (let t = 1; t <= this.squaresNum; t++) e.push(Object.assign({}, this.squareStyle));
                    return e
                }
            }
        };
        ...
        const H = {
            ...
            computed: {
                ...
                circlesStyles() {
                    const e = [],
                        t = .15 * this.animationDuration;
                    for (let i = 0; i < this.circlesNum; i++) e.push(Object.assign({
                        padding: 2 * this.borderWidth * i + "px",
                        animationDelay: `${i===this.circlesNum-1?0:t}ms`
                    }, this.circleStyle));
                    return e
                }
            }
        ...
        s(H, (function() {
            ...
            return i("div", {
                ...
                style: e.spinnerStyle
            }, e._l(e.circlesStyles, (function(t, n) {
                return i("div", {
                    key: n,
                    staticClass: "circle",
                    style: t
        ...
        const G = {
            ...
            computed: {
                ...
                squaresStyles() {
                    const e = [],
                        t = [6, 7, 8, 3, 4, 5, 0, 1, 2],
                        i = .05 * this.animationDuration;
                    for (let n = 0; n < this.squaresNum; n++) e.push(Object.assign({
                        animationDelay: i * t[n] + "ms"
                    }, this.squareStyle));
                    return e
                }
            }
        ...
        const he = s({
            ...
            methods: {
                verifyLicense00: function() {
                    var e = this;
                    axios.get(this.verifyUrl).then((function(t) {
                        t.data.error || (e.verified = !0, e.license = t.data.data), e.isLoading = !1
                    })).catch((function(t) {
                        Botble.handleError(t.response.data), e.isLoading = !1
                    }))
                },
                activateLicense00: function() {
                    var e = this;
                    this.activating = !0, axios.post(this.activateLicenseUrl, {
                        ...
                        t.data.error ? Botble.showError(t.data.message) : (e.verified = !0, e.license = t.data.data, Botble.showSuccess(t.data.message)), e.activating = !1
                    })).catch((function(t) {
                        Botble.handleError(t.response.data), e.activating = !1
                    }))
                },
                deactivateLicense00: function() {
                    var e = this;
                    this.deactivating = !0, axios.post(this.deactivateLicenseUrl).then((function(t) {
                        t.data.error ? Botble.showError(t.data.message) : e.verified = !1, e.deactivating = !1
                    })).catch((function(t) {
                        Botble.handleError(t.response.data), e.deactivating = !1
                    }))
                },
                resetLicense: function() {
                    var e = this;
                    this.deactivating = !0, axios.post(this.resetLicenseUrl, {
                        purchase_code: this.purchaseCode,
                        buyer: this.buyer,
                        license_rules_agreement: this.licenseRulesAgreement
                    }).then((function(t) {
                        if (t.data.error) return Botble.showError(t.data.message), e.deactivating = !1, !1;
                        e.verified = !1, e.deactivating = !1, Botble.showSuccess(t.data.message)
                    })).catch((function(t) {
                        Botble.handleError(t.response.data), e.deactivating = !1
                    }))
                }
            ...
            return i("div", {
            ...
            }, [i("half-circle-spinner", {
                attrs: {
                    "animation-duration": 1e3,
                    size: 15,
                    color: "#808080"
                }
            })], 1) : e._e(), e._v(" "), e.isLoading || e.verified ? e._e() : i("div", [i("div", {
                staticClass: "note note-warning"
            }, ["yes" === e.manageLicense ? i("p", [e._v("Your license is invalid. Please activate your license!")]) : e._e(), e._v(" "), "no" === e.manageLicense ? i("p", [e._v("You doesn't have permission to activate the license!")]) : e._e()]), e._v(" "), i("div", {
            ...
            }, [e._v("Your username on Envato")]), e._v(" "), i("input", {
                directives: [{
                    name: "model",
                    rawName: "v-model",
                    value: e.buyer,
                ...
                attrs: {
                    ...
                    disabled: "no" === e.manageLicense,
                    readonly: "no" === e.manageLicense
                },
                domProps: {
                    value: e.buyer
                },
                on: {
                    input: function(t) {
                        t.target.composing || (e.buyer = t.target.value)
                    }
                }
            }), e._v(" "), e._m(1)]), e._v(" "), i("div", {
                staticClass: "form-group mb-3"
            }, [e._m(2), e._v(" "), i("input", {
                directives: [{
                    name: "model",
                ...
                on: {
                    input: function(t) {
                        t.target.composing || (e.purchaseCode = t.target.value)
                    }
                }
            })]), e._v(" "), i("div", {
                staticClass: "form-group mb-3"
                ...
                domProps: {
                    checked: Array.isArray(e.licenseRulesAgreement) ? e._i(e.licenseRulesAgreement, "1") > -1 : e.licenseRulesAgreement
                },
                on: {
                    change: function(t) {
                        var i = e.licenseRulesAgreement,
                            n = t.target,
                            a = !!n.checked;
                        if (Array.isArray(i)) {
                            var r = e._i(i, "1");
                            n.checked ? r < 0 && (e.licenseRulesAgreement = i.concat(["1"])) : r > -1 && (e.licenseRulesAgreement = i.slice(0, r).concat(i.slice(r + 1)))
                        } else e.licenseRulesAgreement = a
                    }
                }
            }), e._v("Confirm that, according to the Envato License Terms, each license entitles one person\n                            for a single project. Creating multiple unregistered installations is a copyright\n                            violation.\n                            "), i("a", {
                attrs: {
                    href: "https://codecanyon.net/licenses/standard",
                    target: "_blank",
                    rel: "nofollow"
                }
            }, [e._v("More info")]), e._v(".")])]), e._v(" "), i("div", {
                staticClass: "form-group mb-3"
            }, [i("button", {
                class: e.activating ? "btn btn-info button-loading" : "btn btn-info",
                attrs: {
                    type: "button",
                    disabled: "no" === e.manageLicense
                },
                ...
                class: e.deactivating ? "btn btn-info button-loading ms-2" : "btn btn-warning ms-2",
                attrs: {
                    type: "button",
                    disabled: "no" === e.manageLicense
                },
                on: {
                    click: function(t) {
                        return e.resetLicense()
                    }
                }
            }, [e._v("\n                            Reset license on this domain\n                        ")])]), e._v(" "), i("hr"), e._v(" "), e._m(3)]), e._v(" "), !e.isLoading && e.verified ? i("div", [i("p", {
                staticClass: "text-info"
            }, [e._v("\n                        Licensed to " + e._s(e.license.licensed_to) + ". Activated since " + e._s(e.license.activated_at) + ".\n                    ")]), e._v(" "), i("div", {
                staticClass: "form-group mb-3"
            }, [i("button", {
                class: e.deactivating ? "btn btn-warning button-loading" : "btn btn-warning",
                attrs: {
                    type: "button",
                    disabled: "no" === e.manageLicense
                },
            ...
            var e = this,
                t = e.$createElement,
                i = e._self._c || t;
            return i("div", [i("small", [e._v("If your profile page is\n                                "), i("a", {
                attrs: {
                    href: "https://codecanyon.net/user/john-smith",
                    rel: "nofollow"
                }
            }, [e._v("https://codecanyon.net/user/john-smith")]), e._v(", then your username on Envato is "), i("strong", [e._v("john-smith")]), e._v(".")])])
        }, function() {
            var e = this,
                t = e.$createElement,
                i = e._self._c || t;
            ...
            }, [e._v("Note: Your site IP will be added to blacklist after 5 failed attempts.")])]), e._v(" "), i("p", [i("small", [e._v("A purchase code (license) is only valid for One Domain. Are you using this theme on\n                                a new domain? Purchase a\n                                "), i("a", {
                attrs: {
                    href: "https://codecanyon.net/user/botble/portfolio",
                    target: "_blank",
                    rel: "nofollow"
                }
            }, [e._v("new license here")]), e._v("\n                                to get a new purchase code.")])])])
        ...
        function ue(e, t) {
            for (var i = 0; i < t.length; i++) {
                ...
                }(a, "string"), "symbol" === be(r) ? r : String(r)), n)
            }
            var a, r
        }
        "undefined" != typeof vueApp && vueApp.booting((function(e) {
            e.component("license-component", he)
        }));
        var ge = function() {
            function e() {
                ! function(e, t) {
            ...
            return t = e, i = [{
                key: "init",
                value: function() {
                    this.handleMultipleAdminEmails(), $("input[data-key=email-config-status-btn]").on("change", (function(e) {
                    ...
                    })), $(document).on("change", ".setting-select-options", (function(e) {
                        $(".setting-wrapper").addClass("hidden"), $(".setting-wrapper[data-type=" + $(e.currentTarget).val() + "]").removeClass("hidden")
                    })), $(".send-test-email-trigger-button").on("click", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget),
                            i = t.text();
                        t.text(t.data("saving")), $.ajax({
                            type: "POST",
                            url: route("settings.email.edit"),
                            data: t.closest("form").serialize(),
                            success: function(e) {
                                e.error ? Botble.showError(e.message) : (Botble.showSuccess(e.message), $("#send-test-email-modal").modal("show")), t.text(i)
                            },
                            error: function(e) {
                                Botble.handleError(e), t.text(i)
                            }
                        })
                        ...
                        t.addClass("button-loading"), $.ajax({
                            ...
                            data: {
                                email: t.closest(".modal-content").find("input[name=email]").val()
                            },
                            success: function(e) {
                                e.error ? Botble.showError(e.message) : Botble.showSuccess(e.message), t.removeClass("button-loading"), t.closest(".modal").modal("hide")
                            },
                            error: function(e) {
                                Botble.handleError(e), t.removeClass("button-loading"), t.closest(".modal").modal("hide")
                            }
                        })
                    })), $(".generate-thumbnails-trigger-button").on("click", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget),
                            i = t.text();
                        t.text(t.data("saving")), $.ajax({
                            ...
                            data: t.closest("form").serialize(),
                            success: function(e) {
                                e.error ? Botble.showError(e.message) : $("#generate-thumbnails-modal").modal("show"), t.text(i)
                            },
                            error: function(e) {
                                Botble.handleError(e), t.text(i)
                            }
                        })
                    })), $("#generate-thumbnails-button").on("click", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget);
                        t.addClass("button-loading"), $.ajax({
                            type: "POST",
                    ...
                    })), "undefined" != typeof CodeMirror && Botble.initCodeEditor("mail-template-editor"), $(document).on("click", ".btn-trigger-reset-to-default", (function(e) {
                        e.preventDefault(), $("#reset-template-to-default-button").data("target", $(e.currentTarget).data("target")), $("#reset-template-to-default-modal").modal("show")
                    })), $(document).on("click", ".js-select-mail-variable", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget),
                            i = $(".CodeMirror")[0].CodeMirror,
                            n = "{{ " + t.data("key") + " }}";
                        if (i.somethingSelected()) i.replaceSelection(n);
                        else {
                            var a = i.getCursor(),
                                r = {
                                    line: a.line,
                    ...
                    })), $(document).on("click", ".js-select-mail-function", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget),
                            i = $(".CodeMirror")[0].CodeMirror,
                            n = t.data("sample");
                    ...
                    })), $(document).on("click", "#reset-template-to-default-button", (function(e) {
                        e.preventDefault();
                        var t = $(e.currentTarget);
                        t.addClass("button-loading"), $.ajax({
                            type: "POST",
                            ...
                            success: function(e) {
                                e.error ? Botble.showError(e.message) : (Botble.showSuccess(e.message), setTimeout((function() {
                                    window.location.reload()
                                }), 1e3)), t.removeClass("button-loading"), $("#reset-template-to-default-modal").modal("hide")
                            },
                            error: function(e) {
                                Botble.handleError(e), t.removeClass("button-loading")
                            }
                        })
                    ...
                    })), $("input.setting-selection-option").each((function(e, t) {
                        var i = $($(t).data("target"));
                        $(t).on("change", (function() {
                            "1" == $(t).val() ? (i.removeClass("d-none"), Botble.initResources()) : i.addClass("d-none")
                        }))
                    }))
                }
            }, {
                ...
                value: function() {
                    ...
                    if (e.length) {
                        var t = e.find("#add"),
                            i = parseInt(e.data("max"), 10),
                            n = e.data("emails");
                        0 === n.length && (n = [""]);
                        var a = function() {
                                e.find("input[type=email]").length >= i ? t.addClass("disabled") : t.removeClass("disabled")
                            },
                            r = function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
                                return t.before('<div class="d-flex mt-2 more-email align-items-center">\n                <input type="email" class="next-input" placeholder="'.concat(t.data("placeholder"), '" name="admin_email[]" value="').concat(e || "", '" />\n                <a class="btn btn-link text-danger"><i class="fas fa-minus"></i></a>\n            </div>'))
                            };
                        e.on("click", ".more-email > a", (function() {
                            $(this).parent(".more-email").remove(), a()
            ...
            }], i && ue(t.prototype, i), n && ue(t, n), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
